...
if __name__ == "__main__":
    ...
    exp_setting["classifier"] = "Softmax0"
    ...
    if exp == 0:
        ...
        serializers.load_npz(
            "results/DenseNetBtlLadder_2018-08-15_14-30-07_0/DenseNetBtlLadder.npz",
            net
            )

        f = open("results/DenseNetBtlLadder_2018-08-15_14-30-07_0/omax_ts100.pickle", "rb")
        feval = softmax0
        omax = pickle.load(f)
